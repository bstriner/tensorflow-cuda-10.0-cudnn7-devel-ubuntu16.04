# Dockerfile for bstriner/tensorflow-cuda-10.0-cudnn7-devel-ubuntu16.04

FROM bstriner/cuda-10.0-cudnn7-devel-ubuntu16.04
# nohup docker build . -t bstriner/tensorflow-cuda-10.0-cudnn7-devel-ubuntu16.04:36 & disown
# docker login
# docker push bstriner/tensorflow-cuda-10.0-cudnn7-devel-ubuntu16.04:36
# docker run -it bstriner/tensorflow-cuda-10.0-cudnn7-devel-ubuntu16.04:36
...
RUN bazel build --copt=-O3 --copt=-mavx --copt=-mfpmath=both --copt=-msse4.2 :pip_pkg
