...
# nohup docker build . -t bstriner/tensorflow-cuda-10.0-cudnn7-devel-ubuntu16.04:27 & disown
# docker login
# docker push bstriner/tensorflow-cuda-10.0-cudnn7-devel-ubuntu16.04:27
# docker run -it bstriner/tensorflow-cuda-10.0-cudnn7-devel-ubuntu16.04:27
